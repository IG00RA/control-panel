  ...
  return `
    ...
    <html lang="uk">
      <head>
        ...
        <title>Сертифікат про закінчення навчального курсу для ${certificateData.fullName || 'N/A'}</title>
        ...
        <style>
          * {
          ...
          .certificate_block {
            ...
            background-image: url("http://localhost:1337/uploads/certificate.webp");
      ...
      <body>
        <div class="certificate_block">
          <h2 class="certificate_header">Сертифікат про закінчення навчального курсу</h2>
          <p class="certificate_id">Certificate ID: <span>${certificateData.uuid || 'N/A'}</span></p>
          <p class="certificate_name_text">Цей документ підтверджує, що</p>
          <h2 class="certificate_name">${certificateData.fullName || 'N/A'}</h2>
          <p class="certificate_name_bottom_text">курс “Арбітраж трафіку” від команди Mustage Team</p>
          <div class="period_wrap">
            <p class="certificate_thread">Потік №: <span>${certificateData.streamNumber || 'N/A'}</span></p>
            <p class="certificate_period">Період навчання: <span>${period}</span></p>
          </div>
          <p class="certificate_format">Формат навчання: <span>${format}</span></p>
          <div class="certificate_bottom_wrap">
            <div class="certificate_qr">
              <img src="http://localhost:1337${certificateData.qrCode || '/uploads/qr.webp'}" alt="Mustage qr code" class="qr_code" />
            </div>
            <div class="certificate_seo_wrap">
              <p class="certificate_seo_text"><span>Денис Панкратов</span> СЕО Mustage Team</p>
              <div class="certificate_stamp_wrap">
                <img src="http://localhost:1337/uploads/stamp.webp" alt="Mustage stamp" class="stamp" />
                <p class="certificate_stamp_id">Certificate ID: <span>${certificateData.uuid || 'N/A'}</span></p>
                <img src="http://localhost:1337/uploads/seo_sign.webp" alt="SEO sign" class="sign" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="certificate_block">
          <div>
            ...
            <p class="supplement_id">Certificate ID: <span>${certificateData.uuid || 'N/A'}</span></p>
            <p class="supplement_student">Студент: <span>${certificateData.fullName || 'N/A'}</span></p>
            <p class="supplement_thread">Потік №: <span>${certificateData.streamNumber || 'N/A'}</span></p>
            <p class="supplement_period">Період навчання: <span>${period}</span></p>
            <p class="supplement_format">Формат навчання: <span>${format}</span></p>
            <h3 class="supplement_curator_text">Характеристика та рекомендації від куратора курсу:</h3>
            <p class="supplement_text">${certificateData.recommendationsCurator || 'N/A'}</p>
          </div>
          <div class="supplement_seo_wrap">
            <p class="supplement_seo_text"><span>Максим Язвінський</span> Куратор курсу</p>
            <div class="certificate_stamp_wrap">
              <img src="http://localhost:1337/uploads/stamp.webp" alt="Mustage stamp" class="stamp" />
              <p class="certificate_stamp_id">Certificate ID: <span>${certificateData.uuid || 'N/A'}</span></p>
              <img src="http://localhost:1337/uploads/curator_sign.webp" alt="Curator sign" class="sign" />
            </div>
          </div>
        </div>
        ...
        <div class="certificate_block">
          <div>
            <h3 class="supplement_curator_text">Характеристика та рекомендації від наставника курсу:</h3>
            <p class="supplement_text">${certificateData.recommendationsMentor || 'N/A'}</p>
          </div>
          <div class="supplement_seo_wrap">
            <p class="supplement_seo_text"><span>Дмитро Вартанян</span> Наставник курсу</p>
            <div class="certificate_stamp_wrap">
              <img src="http://localhost:1337/uploads/stamp.webp" alt="Mustage stamp" class="stamp" />
              <p class="certificate_stamp_id">Certificate ID: <span>${certificateData.uuid || 'N/A'}</span></p>
              <img src="http://localhost:1337/uploads/mentor_sign.webp" alt="Mentor sign" class="sign" />
            </div>
          </div>
        </div>
          ...
          <table class="report_table">
            <thead>
              <tr>
                ...
                <th class="table_header">Оцінка за тест <span>(0-12 балів)</span></th>
                <th class="table_header">Оцінка за домашнє завдання <span>(0-12 балів)</span></th>
              </tr>
            </thead>
            <tbody>
              <tr>
              ...
              <tr>
                <td class="first_column">Урок 1.1 “19 порад арбітражникам-початківцям”</td>
                <td class="second_column">${getGradeData('1.1').tests}</td>
                <td class="third_column">${getGradeData('1.1').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 1.2 “Що таке арбітраж, які є гравці в цій ніші, вертикалі, за що платить рекламодавець у ніші гемблінгу, як рекламодавець оцінює трафік”</td>
                <td class="second_column">${getGradeData('1.2').tests}</td>
                <td class="third_column">${getGradeData('1.2').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 1.3 “Термінологія в арбітражі трафіку”</td>
                <td class="second_column">${getGradeData('1.3').tests}</td>
                <td class="third_column">${getGradeData('1.3').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 1.4 “Вибір гео та офферу, на що звертати увагу”</td>
                <td class="second_column">${getGradeData('1.4').tests}</td>
                <td class="third_column">${getGradeData('1.4').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 1.5 “Як зареєструватися на Binance та переказати гроші”</td>
                <td class="second_column">${getGradeData('1.5').tests}</td>
                <td class="third_column">${getGradeData('1.5').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 2.1 “Що таке антидетект браузер. Встановлення антидетект браузера на комп'ютер”</td>
                <td class="second_column">${getGradeData('2.1').tests}</td>
                <td class="third_column">${getGradeData('2.1').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 2.2 “Що таке проксі? Де взяти проксі, як купити (мобільні проксі), як їх завести в антик”</td>
                <td class="second_column">${getGradeData('2.2').tests}</td>
                <td class="third_column">${getGradeData('2.2').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 2.3 “Покупка облікових записів. Передача в долфін та завод з куків”</td>
                <td class="second_column">${getGradeData('2.3').tests}</td>
                <td class="third_column">${getGradeData('2.3').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 2.4 “Облік розхідників у гугл таблицях”</td>
        ...
        <div class="certificate_block">
          ...
          <table class="report_table">
            ...
            <tbody>
              <tr>
                <td class="first_column">Урок 5.3 “Лінкування саморегів у бізнес менеджери”</td>
                <td class="second_column">${getGradeData('5.3').tests}</td>
                <td class="third_column">${getGradeData('5.3').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 5.4 “Що робити, якщо не створюється бізнес-менеджер?”</td>
                <td class="second_column">${getGradeData('5.4').tests}</td>
                <td class="third_column">${getGradeData('5.4').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 5.5 “Як додати рекламний кабінет у бізнес-менеджер? Лінкування саморегів у кінгу”</td>
                <td class="second_column">${getGradeData('5.5').tests}</td>
                <td class="third_column">${getGradeData('5.5').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 6.1 “Запуск реклами на гемблінг програми. Розбір детального націлення”</td>
                <td class="second_column">${getGradeData('6.1').tests}</td>
                <td class="third_column">${getGradeData('6.1').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 6.2 “Як отримати код від фейсбука без номера телефону? Огляд сервісу для прийому смс”</td>
                <td class="second_column">${getGradeData('6.2').tests}</td>
                <td class="third_column">${getGradeData('6.2').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 6.3 “Проходження чеків. 1 частина”</td>
                <td class="second_column">${getGradeData('6.3').tests}</td>
                <td class="third_column">${getGradeData('6.3').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 6.4 “Що робити, якщо летять ризики? Як зробити препей акаунти ФБ”</td>
                <td class="second_column">${getGradeData('6.4').tests}</td>
                <td class="third_column">${getGradeData('6.4').homework}</td>
              </tr>
              <tr>
                <td class="first_column">Урок 6.5 “Аналіз рекламних кампаній та трафіку. Проходження чеків 2 частина”</td>
          ...
          <p class="notion_link">
            ...
            <a href="${certificateData.caseLink || 'N/A'}" target="_blank" rel="noopener noreferrer">${certificateData.caseLink || 'N/A'}</a>
          </p>
          <p class="average_grade">Середній бал за курс: <span>${certificateData.averageGradePoints || 'N/A'}</span></p>
          `
              : ''
          }
        </div>
